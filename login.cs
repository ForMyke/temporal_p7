...
public class login
{
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequest req)
    {
        try
        {
            ...
            try
            {
                var cmd_1 = new MySqlCommand("SELECT id_usuario FROM usuarios WHERE email=@email and password=@password");
                ...
                int id_usuario = 0;
                if (r.Read()) id_usuario = r.GetInt32(0);
                ...
                if (id_usuario != 0)
                {
                    ...
                    return new OkObjectResult("{\"id_usuario\":" + id_usuario + "," + "\"token\":\"" + token + "\"}");
                }
